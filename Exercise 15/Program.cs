...
namespace Exercise_15
{
     ...
     * Use a for loop to output the cubes of all the numbers from 1 to that number.
     */
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do // Loop to finish the application
            {
                ...
                // Give a list of all the cubes from 1 to the chosen number
                for (int i = 1; i <= userNumber; i++)
                {
                    Console.Write($"{Math.Pow(i, 3)} "); // Math.Pow(base, power)
                }
